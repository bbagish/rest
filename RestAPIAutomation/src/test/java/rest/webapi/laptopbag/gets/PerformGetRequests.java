...
public class PerformGetRequests {
	...
	public void testPingMethod() throws URISyntaxException {
		URI pingURI=new URI("http://localhost:8080/laptop-bag/webapi/api/ping/Belek");
		Response response=when().get(pingURI);
		assertEquals(200, response.statusCode());
		assertEquals("Hi! Belek", response.body().asString());
		System.out.println();
	}
	@Test
	public void testPingWithNoArgs() throws URISyntaxException {
		URI pingURI=new URI("http://localhost:8080/laptop-bag/webapi/api/ping/");
		Response response=when().get(pingURI);
	...
	public void testALLMethod() throws URISyntaxException{
		URI allURI=new URI("http://localhost:8080/laptop-bag/webapi/api/all");
	...
	public void testFindWithID() throws URISyntaxException{
		URI findURI=new URI("http://localhost:8080/laptop-bag/webapi/api/find/150");
